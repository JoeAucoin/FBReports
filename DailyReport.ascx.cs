...
{
    public partial class ReportDaily : PortalModuleBase, IActionable
    {
        ...
        public void Fill_ClientsDetails()
        {
            ...
            try
            {
                ...
                items = controller.FBReports_Client_Visit_Details(_startDate, _endDate, this.PortalId, ddlLocations.SelectedValue.ToString());
        ...
        public void GroupIt()
        {
            ...
            //   
                ...
                helper.RegisterSummary("VisitNumBags", SummaryOperation.Sum, "ClientCity");
                ...
                helper.RegisterSummary("VisitNumBags", SummaryOperation.Sum);
                ...
                //GridViewGroup g = helper.RegisterGroup("ClientCity", true, true);
                //helper.RegisterSummary("HouseholdTotal", SummaryOperation.Sum, "ClientCity");
                //helper.ApplyGroupSort();
